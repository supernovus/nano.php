...
class Dispatch
{
  ...
  public function __construct ($opts=[])
  {
    ...
    $nano->addMethod('dispatch', [$this, 'dispatch']);
  ...
  public function registerExtensions ()
  {
    ...
    $nano->addMethod('addRoute',     [$this, 'addRoute']);
    $nano->addMethod('addRoutes',    [$this, 'addRoutes']);
    $nano->addMethod('setDefault',   [$this, 'addDefaultController']);
    $nano->addMethod('setRoot',      [$this, 'addRootController']);
    $nano->addMethod('addPrefix',    [$this, 'addPrefixController']);
    $nano->addMethod('addSingle',    [$this, 'addSingleController']);
    $nano->addMethod('addNested',    [$this, 'addNestedController']);
    $nano->addMethod('redirectRoot', [$this, 'addRootRedirect']);
  }
  ...
  { // Extracted from get_routing for use elsewhere.
    ...
    $path = self::remove_invisible_characters($path, FALSE);
   ...
   */
  static function get_routing ($path=null) 
...
#      error_log("stripping {$this->url_prefix} from $path");
    ...
    $our_paths = self::get_routing($path);
