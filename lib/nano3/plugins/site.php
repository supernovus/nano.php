 ...
 * full access to Nano3 features from each site page.
 *
 */
 ...
 * and provide Nano3 features to. The template can be a path to a
...
class Site
{
  ...
  public function end ()
  {
    ...
    { // We're using an include file.
      $output = \Nano3\get_php_content($template, $pagedata);
    }
    echo $output;
  }
